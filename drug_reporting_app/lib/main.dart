    ...
    return Scaffold(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Container(
                        width: 400,
                        child: Text(
                          'is there information about the drug used',
                          style: TextStyle(color: Colors.black, fontSize: 15),
                        ),
                      ),
                      SizedBox(
                      ...
                      GestureDetector(
                        onTap: () async {
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) => Next(dateget: date, street: street, drugtype: drug,)));
                        },
                        child: Container(
                          height: 40,
                          width: 300,
      ...
      floatingActionButton: Padding(
        ...
        child: Container(
          height: 40,
          width: 170,
          decoration: BoxDecoration(color: Color.fromARGB(255, 20, 58, 133),borderRadius: BorderRadius.circular(12)),
          child: Center(
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Text("Hurry? Call us",style: TextStyle(fontSize: 14,color: Colors.white ),),
                  SizedBox(width: 4,),
